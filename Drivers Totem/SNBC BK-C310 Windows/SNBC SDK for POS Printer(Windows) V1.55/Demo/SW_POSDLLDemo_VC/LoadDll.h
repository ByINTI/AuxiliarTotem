...
#define POS_OPEN_CLASSPRINTER 0X16 // 类模式
...
typedef int (__stdcall *POS_EnumUSBPrinter)(char* cPrinterName);
...
typedef int (__stdcall *POS_Raster_DownloadAndPrintBmp)(char *, int);

typedef int (__stdcall *POS_Raster_DownloadAndPrintBmpEx)(char *, int, int, int, int);

typedef int (__stdcall *POS_SetPrintDensity)(int);
