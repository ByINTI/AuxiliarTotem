...
extern POS_Raster_DownloadAndPrintBmp	VC_POS_Raster_DownloadAndPrintBmp;

extern POS_Raster_DownloadAndPrintBmpEx	VC_POS_Raster_DownloadAndPrintBmpEx;
extern POS_SetPrintDensity				VC_POS_SetPrintDensity;
...
BOOL PrintInStandardMode80(void)
{
	...
	VC_POS_S_TextOut("SNBC POS Thermal Printer", 50, 2, 3, POS_FONT_TYPE_STANDARD, 
	...
	VC_POS_S_TextOut("SNBC POS Thermal Printer", 20, 1, 1, POS_FONT_TYPE_CHINESE,
	...
	VC_POS_SetRightSpacing(2);
	VC_POS_S_TextOut("Normal font print", 20, 1, 1, POS_FONT_TYPE_CHINESE,
		POS_FONT_STYLE_NORMAL);
	VC_POS_FeedLine();
	VC_POS_S_TextOut("Reverse display font print", 20, 1, 1, POS_FONT_TYPE_CHINESE,
		POS_FONT_STYLE_REVERSE);
	VC_POS_FeedLine();
	VC_POS_S_TextOut("Clockwise rotate 90 print", 20, 1, 1, POS_FONT_TYPE_CHINESE,
		POS_FONT_STYLE_CLOCKWISE_90);
	VC_POS_FeedLine();
	VC_POS_S_TextOut("Inverted font print", 20, 1, 1, POS_FONT_TYPE_CHINESE,
	...
	VC_POS_FeedLine();
	VC_POS_S_TextOut("-------------> Double width print", 20, 1, 1, POS_FONT_TYPE_STANDARD, POS_FONT_STYLE_NORMAL);
	VC_POS_FeedLine();
	nRet = VC_POS_Raster_DownloadAndPrintBmpEx("Kitty.bmp", 0, 2, 1, 10);
	if (POS_SUCCESS != nRet)
	{
		return FALSE;
	}
	...
	VC_POS_FeedLine();
	VC_POS_S_TextOut("-------------> Double heigh print", 20, 1, 1, POS_FONT_TYPE_STANDARD, POS_FONT_STYLE_NORMAL);
	VC_POS_FeedLine();
	nRet = VC_POS_Raster_DownloadAndPrintBmpEx("Look.bmp", 3, 1, 2, 10);
	if (POS_SUCCESS != nRet)
	{
		return FALSE;
	}

	VC_POS_SetPrintDensity(140);
	VC_POS_S_TextOut("Print density test! Print density test! Print density test!", 20, 1, 1, POS_FONT_TYPE_STANDARD, POS_FONT_STYLE_NORMAL);
