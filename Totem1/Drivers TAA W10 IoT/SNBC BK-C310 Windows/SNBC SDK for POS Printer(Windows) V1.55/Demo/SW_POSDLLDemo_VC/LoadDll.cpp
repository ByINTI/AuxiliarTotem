...
POS_EnumUSBPrinter				VC_POS_EnumUSBPrinter			= NULL;
...
POS_Raster_DownloadAndPrintBmpEx	VC_POS_Raster_DownloadAndPrintBmpEx = NULL;

POS_SetPrintDensity					VC_POS_SetPrintDensity		= NULL;
...
bool LoadPosdll(void)
{
	...
	VC_POS_EnumUSBPrinter = (POS_EnumUSBPrinter)GetProcAddress(g_hPosdll, "POS_EnumUSBPrinter");
	if (VC_POS_EnumUSBPrinter == NULL)
	{
		return false;
	}

	VC_POS_Raster_DownloadAndPrintBmp = (POS_Raster_DownloadAndPrintBmp)GetProcAddress(g_hPosdll, "POS_Raster_DownloadAndPrintBmp");
	if (VC_POS_Raster_DownloadAndPrintBmp == NULL)
	{
		return FALSE;
	}

	VC_POS_Raster_DownloadAndPrintBmpEx = (POS_Raster_DownloadAndPrintBmpEx)GetProcAddress(g_hPosdll, "POS_Raster_DownloadAndPrintBmpEx");
	if (VC_POS_Raster_DownloadAndPrintBmpEx == NULL)
	{
		return FALSE;
	}

	VC_POS_SetPrintDensity = (POS_SetPrintDensity)GetProcAddress(g_hPosdll, "POS_SetPrintDensity");
	if (VC_POS_SetPrintDensity == NULL)
	{
		return FALSE;
	}
